...
// Add a layer group for the earthquake data 
...
// Add a reference to the earthquake, tectonic plates, and major earthquakes groups to the overlays object.
let overlays = {
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(tectonicData) {
    ...
    // add the tetonic plates GeoJSON layer to the tetonic plates group layer
