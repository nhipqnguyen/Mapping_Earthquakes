...
// We create the satellitestreet view tile layer that will be an option for our map.
...
// Create the map object with center of United States, zoom level and default layer.
let map = L.map('mapid', {
  center: [39.5, -98.5],
  zoom: 3,
